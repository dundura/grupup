...
import { Plus, Users, Search, Star, MapPin, Pencil, CheckCircle, AlertCircle, ExternalLink } from "lucide-react";
  ...
  useEffect(() => {
    ...
    if (role === "trainer") {
      fetch("/api/trainer/profile")
        .then((r) => r.json())
        .then((d) => { setTrainerProfile(d ?? null); setProfileLoading(false); })
      ...
      <div className="container max-w-4xl py-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl border p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              href={role === "trainer" ? "/trainer/setup" : "/profile"}
            ...
            <div className="space-y-3">
              ...
              {profileComplete ? (
                ...
                <div className="flex items-center gap-2 text-amber-700 bg-amber-50 rounded-lg px-3 py-2 text-sm">
                  ...
                  <Link href="/trainer/setup" className="ml-auto text-xs font-medium hover:underline">
                    Finish setup →
                  </Link>
                </div>
              )}

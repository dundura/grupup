    ...
    if (booking.userEmail && process.env.RESEND_API_KEY) {
      try {
        ...
        await resend.emails.send({
          ...
          bcc: ADMIN_BCC,
          subject: "Your booking has been cancelled & refunded",
          html: `
            <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px;">
              ...
              <p style="color: #374151; font-size: 15px;">Your booking has been cancelled and <strong>$${booking.amountPaid}</strong> will be refunded to your original payment method within 5–10 business days.</p>

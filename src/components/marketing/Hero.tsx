          ...
          <div className="grid lg:grid-cols-[1fr_360px] gap-6 items-start">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="text-[#DC373E] uppercase leading-tight mb-3 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[56px] sm:mt-1"
            ...
            <div className="hidden lg:flex flex-col gap-3">
              ...
              {/* Highlights card */}
              <div className="relative z-20 bg-white rounded-2xl px-3 py-2 shadow-sm divide-y divide-gray-100 mt-20">
                {highlights.map((item) => (
